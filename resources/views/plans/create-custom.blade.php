    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('plans.index') }}"
                class="bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs font-extrabold px-4 py-2 rounded-xl transition-all hover:scale-105">
                ← Back to Plans
            </a>
        </div>
    </x-slot>
    ...
    <div class="py-12 max-w-xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white p-8 rounded-2xl shadow-sm border border-slate-200/80 hover:shadow-md transition-all duration-300">
            <div class="flex items-center gap-3.5 mb-6 pb-4 border-b border-slate-100">
                <div class="w-11 h-11 rounded-xl bg-indigo-50 text-indigo-600 flex items-center justify-center text-xl font-bold shadow-2xs">
                    📋
                </div>
                <div>

<x-guest-layout>
    <div class="mb-6">
        <h3 class="text-xl font-black text-white">Create New Account</h3>
        <p class="text-xs text-slate-400 font-medium mt-1">Deploy your biometric profile and custom diet journal.</p>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}" class="space-y-4">
        ...
        <div class="text-center pt-2 border-t border-slate-700/60 mt-4">
            <p class="text-xs font-medium text-slate-400">
                Already registered?
                <a href="{{ route('login') }}" class="text-emerald-400 hover:underline font-bold ms-1">Sign In</a>
            </p>
        </div>
    </form>
</x-guest-layout>

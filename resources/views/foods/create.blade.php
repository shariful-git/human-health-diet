        ...
        <div class="flex items-center justify-between">
            <div>
                <h2 class="font-extrabold text-xl text-slate-900 tracking-tight flex items-center gap-2">
                    ...
                    Add Custom Personal Food (নতুন ফুড যুক্ত করুন)
                </h2>
    ...
    <div class="py-8 max-w-4xl mx-auto sm:px-6 lg:px-8">
        <form action="{{ route('foods.store') }}" method="POST" class="bg-white p-8 rounded-3xl border border-slate-200/80 shadow-md space-y-6">
            ...
            <div class="border-b border-slate-100 pb-4">
                <h3 class="text-base font-extrabold text-slate-900">General Information (সাধারণ তথ্য)</h3>
                <p class="text-xs text-slate-500">Provide name, category, and standard serving size for your custom food.</p>
            </div>

            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    <label class="block text-xs font-extrabold text-slate-700 mb-2">Food Name (খাবারের নাম) *</label>
                ...
                <div>
                    <label class="block text-xs font-extrabold text-slate-700 mb-2">Category (ক্যাটাগরি) *</label>
                ...
                <div>
                    <label class="block text-xs font-extrabold text-slate-700 mb-2">Serving Size (পরিমাণ) *</label>
            ...
            <div class="border-b border-slate-100 pb-4 pt-4">
                <h3 class="text-base font-extrabold text-slate-900">Macronutrients & Micronutrients (পুষ্টি গুণাগুণ)</h3>

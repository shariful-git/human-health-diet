        ...
        <div class="flex items-center justify-between">
            <div>
                <h2 class="font-extrabold text-xl text-slate-900 tracking-tight flex items-center gap-2">
                    ...
                    Health Parameters & Profile Configuration
                </h2>
                ...
                <form method="POST" action="{{ route('profile.update') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <select id="gender" name="gender"
                            class="block w-full rounded-xl border-slate-200 bg-white text-xs font-semibold text-slate-800 shadow-2xs focus:border-emerald-500 focus:ring-emerald-500 py-3">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                        <div>
                            ...
                            <x-text-input id="age" name="age" type="number" class="block w-full rounded-xl border-slate-200 text-xs font-semibold text-slate-800 shadow-2xs focus:border-emerald-500 focus:ring-emerald-500 py-3"
                        ...
                        <div>
                            ...
                            <x-text-input id="height" name="height" type="number" step="0.1"
                                class="block w-full rounded-xl border-slate-200 text-xs font-semibold text-slate-800 shadow-2xs focus:border-emerald-500 focus:ring-emerald-500 py-3" :value="old('height', $profile?->height)" required />
                        ...
                        <div>
                            ...
                            <x-text-input id="weight" name="weight" type="number" step="0.1"
                                class="block w-full rounded-xl border-slate-200 text-xs font-semibold text-slate-800 shadow-2xs focus:border-emerald-500 focus:ring-emerald-500 py-3" :value="old('weight', $profile?->weight)" required />
                    ...
                    <div class="pt-4 flex items-center gap-4 border-t border-slate-100">
                        <button type="submit"
                            class="w-full bg-slate-900 hover:bg-emerald-600 text-white font-extrabold h-12 rounded-xl shadow-sm transition-all text-xs flex items-center justify-center gap-2 hover:scale-[1.01]">
